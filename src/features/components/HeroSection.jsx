  ...
  return (
    <>
        ...
        <article className='flex flex-col w-full justify-center md:flex-row-reverse md:h-[490px]'>
            ...
            <div className='h-full overflow-hidden md:w-1/3 lg:w-[57.5%] md:hidden lg:block'>
                <img className='h-full w-full lg:object-cover' src="features/desktop/hero.jpg" alt="" />
            </div>
            ...
            <div className="px-7 bg-black text-white md:w-2/3 md:px-0 lg:w-[42.5%]">
                ...
                <div className='md:h-full md:flex md:flex-col md:justify-center'>
                    <div className="flex flex-row">
                        ...
                        {/* Main text */}
                        <div className="py-[72px] md:flex md:flex-col md:justify-center md:p-0 md:px-14 lg:max-w-[700px] lg:mx-auto lg:px-14">
